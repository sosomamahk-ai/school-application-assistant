export const MASTER_TEMPLATE_DATA = {
  schoolId: 'template-master-all-fields',
  schoolName: {
  ...
  fieldsData: [
    ...
    },
    {
      ...
      label: '父亲信息 / Father Information',
      type: 'section',
      fields: [
        {
          id: 'father_name',
          label: '父亲姓名 (Father Name)',
          type: 'text',
          required: false,
    ...
    },
    {
      ...
      label: '母亲信息 / Mother Information',
      type: 'section',
      fields: [
        {
          id: 'mother_name',
          label: '母亲姓名 (Mother Name)',
          type: 'text',
          required: false,
...
export type MasterTemplateData = typeof MASTER_TEMPLATE_DATA;
